...
public class AddRuleBefore extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, MultiSelectionSpinner.OnMultipleItemsSelectedListener {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        ...
                        try {
                            if (response.getString("msg").equals("202")) {
                                ...
                                // ArrayAdapter agentDATA_adapter;
                                //agentDATA_adapter = new ArrayAdapter(AddRuleBefore.this, android.R.layout.select_dialog_multichoice, agent_list_API_POJO);
                            /*    agentDATA_adapter.setDropDownViewResource(android.R.layout.simple_list_item_multiple_choice);*/
    ...
    private void insertBlackListDTMF(String case2caller, String case2desc) {
        ...
        fellTheHEAT();
/*
        client.post(Urls.add_rule_DTMF + userUID, params, new JsonHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                pDialog.show();
...
*/
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (!(agent_list_API.isEmpty()) || !(agent_list_API_POJO.isEmpty())) {
