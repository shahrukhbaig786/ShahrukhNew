...
public class AgentProfile extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.update_btn_setting) {
            ...
            add_agent.setOnClickListener(AgentProfile.this);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.add_agent) {
            DBHandler storage = new DBHandler(AgentProfile.this);
            ...
            if (isTrue) {
                ...
                pDialog = new ProgressDialog(AgentProfile.this);
                ...
                client.post(Urls.agent_update + uid + "&id=" + agent_uid, params, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        if (response == null || response.length() == 0) {
                            Toast.makeText(AgentProfile.this, " Failed Check Network", Toast.LENGTH_LONG).show();
                            return;
                        } else {
                            try {
                                if (response.getString("msg").equals("200")) {
                                    pDialog.dismiss();
                                    Urls.createDialogSuccess(AgentProfile.this, Urls.AlertMsgs.Updated);
                                    ...
                                    pDialog.dismiss();
                                    Urls.createDialog(AgentProfile.this, Urls.AlertMsgs.errorMsg);
                                }

                            } catch (Exception e) {
                                Toast.makeText(AgentProfile.this, " Error " + e, Toast.LENGTH_LONG).show();
                                e.printStackTrace();
                            }
                        }
                    ...
                    public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                        Toast.makeText(AgentProfile.this, " Error " + throwable, Toast.LENGTH_LONG).show();
                    }
                });


            } else {
                Urls.createDialog(AgentProfile.this, Urls.AlertMsgs.allFieldsMsg);
            }
